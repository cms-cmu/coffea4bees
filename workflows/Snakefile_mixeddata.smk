...
rule run_postfit:
    ...
    shell:
        ...
        source workflows/helpers/shell_combine.sh {params.container} \
            python3 src.stat_analysis/plots/make_postfit_plot.py -i {params.output_dir}/fitDiagnostics_SvB_MA_unblinded_prefit_sb.root -o {params.output_dir}/plots/ -t prefit
        source workflows/helpers/shell_combine.sh {params.container} \
            python3 src.stat_analysis/plots/make_postfit_plot.py -i {params.output_dir}/fitDiagnostics_SvB_MA_unblinded_prefit_sb.root -o {params.output_dir}/plots/ -t fit_s
        source workflows/helpers/shell_combine.sh {params.container} \
            python3 src.stat_analysis/plots/make_postfit_plot.py -i {params.output_dir}/fitDiagnostics_SvB_MA_unblinded_prefit_sb.root -o {params.output_dir}/plots/ -t fit_b
        """
