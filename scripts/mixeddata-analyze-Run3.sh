...
#YEARS="UL18"
python runner.py  -o histMixedDataRun3.coffea -d    mixeddata_4b_noTT  -p coffea4bees/analysis/processors/processor_HH4b.py -y $YEARS  -op $OUTPUT_DIR -m $DATASETS -c coffea4bees/analysis/metadata/HH4b_mixed_data_new.yml --condor
