...
#time python runner.py -s -p coffea4bees/skimmer/processor/make_declustered_data_4b.py -c ${OUTPUT_DIR}/declustering_seed_${new_seed}.yml -y UL17 UL18 UL16_preVFP UL16_postVFP -d data -op ${OUTPUT_DIR}/ -o picoaod_datasets_declustered_data_Run2_seed${new_seed}.yml -m coffea4bees/metadata/datasets/ --condor   # --dask
