...
display_section_header "Running test processor "
# python src/tools/merge_yaml_datasets.py -m coffea4bees/metadata/datasets_HH4b_Run2/ -f ${OUTPUT_DIR}/picoaod_datasets_TT_pseudodata_Run2.yml  -o ${OUTPUT_DIR}datasets_TT_pseudodata_Run2.yml
