...
display_section_header "Running test processor "
# python src/tools/merge_yaml_datasets.py -m coffea4bees/metadata/datasets/ -f ${OUTPUT_DIR}/picoaod_datasets_TT_pseudodata_Run2.yml  -o ${OUTPUT_DIR}datasets_TT_pseudodata_Run2.yml
...
#time python runner.py -o histAll_TT.coffea            -d TTToHadronic TTToSemiLeptonic TTTo2L2Nu                         -p coffea4bees/analysis/processors/processor_HH4b.py  -y UL17 UL18 UL16_preVFP UL16_postVFP  -op output/ -c coffea4bees/analysis/metadata/HH4b_rerun_SvB.yml 
