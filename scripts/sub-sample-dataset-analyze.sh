...
display_section_header "Running test processor "
# python src/tools/merge_yaml_datasets.py -m coffea4bees/metadata/datasets/ -f ${OUTPUT_DIR}/picoaod_datasets_TTToHadronic_pseudodata_test_UL18.yml  -o ${OUTPUT_DIR}/datasets_TT_pseudodata_test.yml
