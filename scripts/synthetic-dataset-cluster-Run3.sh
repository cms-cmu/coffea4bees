...
JOB="synthetic_dataset_cluster_Run3"
OUTPUT_DIR=$OUTPUT_BASE_DIR/$JOB
create_output_directory "$OUTPUT_DIR"

display_section_header "Input Datasets"
DATASETS=${DATASET:-"coffea4bees//metadata/datasets/"}
#DATASETS="coffea4bees/metadata/datasets/archive/datasets_fourTag_2025_skims.yml"
...
# Create output directory
OUTPUT_DIR="$OUTPUT_BASE_DIR/jetDeclustering_cluster"
create_output_directory "$OUTPUT_DIR"


display_section_header "Changing metadata"
JOB_CONFIG=coffea4bees/analysis/metadata/cluster_4b_Run3.yml
...
#    coffea4bees/analysis/metadata/cluster_4b_Run3.yml > $JOB_CONFIG
...
bash coffea4bees/scripts/run-analysis-processor.sh \
    ...
    --datasets "data" \
    --year "${YEARS}" \
    --output-filename "test_synthetic_datasets_2022_EE.coffea" \
    --output-subdir "$JOB" \
    --config "$JOB_CONFIG" \
...
# python runner.py -t -o test_synthetic_datasets_Run3.coffea -d data  -p coffea4bees/analysis/processors/processor_cluster_4b.py -y 2022_EE 2022_preEE 2023_BPix 2023_preBPix  -op $OUTPUT_DIR -m coffea4bees/metadata/datasets_fourTag_v3.yml -c coffea4bees/analysis/metadata/cluster_4b_noTTSubtraction.yml
...
# python runner.py  -o test_synthetic_datasets_cluster_2023_preBPix.coffea -d data  -p coffea4bees/analysis/processors/processor_cluster_4b.py -y 2023_preBPix   -op output/ -m coffea4bees/metadata/datasets_fourTag.yml -c coffea4bees/analysis/metadata/cluster_4b_noTTSubtraction.yml
