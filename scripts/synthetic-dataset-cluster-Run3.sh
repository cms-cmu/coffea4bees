...
# python runner.py  -o test_synthetic_datasets_cluster_2023_preBPix.coffea -d data  -p coffea4bees/analysis/processors/processor_cluster_4b.py -y 2023_preBPix   -op hists/ -m coffea4bees/metadata/datasets_fourTag.yml -c coffea4bees/analysis/metadata/cluster_4b_noTTSubtraction.yml
