...
### needs to change
python runner.py -t -o testSignals.coffea -d ZH4b ZZ4b  -p coffea4bees/analysis/processors/processor_HH4b.py -y UL17 UL18 UL16_preVFP UL16_postVFP    -op $OUTPUT_DIR -m coffea4bees/metadata/datasets/2024_v1/datasets_HH4b_v1p1.yml -c coffea4bees/analysis/metadata/HH4b_nottcheck.yml
