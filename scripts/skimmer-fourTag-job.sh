...
#time python runner.py -s -p coffea4bees/skimmer/processor/skimmer_4b.py -c coffea4bees/skimmer/metadata/HH4b_fourTag.yml -y UL18 UL17 UL16_preVFP UL16_postVFP -d data -op coffea4bees/skimmer/metadata/ -o picoaod_datasets_fourTag_data_Run2.yml -m coffea4bees/metadata/datasets_HH4b_Run2/
